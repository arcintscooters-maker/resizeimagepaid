...
RUN python -c "from rembg import remove, new_session; from PIL import Image; s=new_session('isnet-general-use'); remove(Image.new('RGB',(10,10)), session=s); print('ISNet ready')" || true
